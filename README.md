...
- [Reguła kalibracji i zamrożenia](../GIA-TIMDR/docs/theory/TIMDR_CALIBRATION_FREEZE_RULE.md)
- [Specyfikacja gałęzi](../GIA-TIMDR/docs/theory/TIMDR_Branch_Specification.md)
